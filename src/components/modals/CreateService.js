          ...
          {step === 1 ? (
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-3 rounded-md mb-4">
                <p className="text-sm font-medium text-gray-700">Doanh nghiệp: <span className="text-blue-600">{service.companyName}</span></p>
                <p className="text-xs text-gray-500 mt-1">Địa chỉ: {service.address}</p>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                    <FileText className="ml-3 text-gray-400" size={16} />
                    <input
                      type="text"
                      id="name"
                      name="name"
                ...
                <div>
                  ...
                  <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                    <Building className="ml-3 text-gray-400" size={16} />
                    <select
                      id="type"
                      name="type"
                      value={service.type}
